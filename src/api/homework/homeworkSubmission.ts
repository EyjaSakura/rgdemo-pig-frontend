...
export function fetchList(query?: Object) {
  return request({
    url: '/homework/homeworkSubmission/page',
    method: 'get',
    params: query
  })
}
...
export function addObj(obj?: Object) {
  return request({
    url: '/homework/homeworkSubmission',
    method: 'post',
    data: obj
  })
}
...
export function getObj(obj?: Object) {
  return request({
    url: '/homework/homeworkSubmission/details',
    method: 'get',
    params: obj
  })
}
 ...
 *       validateExist(rule, value, callback, form.submissionId !== '');
 *     },
 *     trigger: 'blur',
 *   },
 * ]
